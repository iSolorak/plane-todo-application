...
//
//  - EAS_PROJECT_ID: your Expo project id (run `eas init`, or set it in .env).
//  - GOOGLE_SERVICES_JSON: path to your Firebase google-services.json used for
//    Android FCM push. Defaults to ./google-services.json. Only attached when
//    the file actually exists, so `expo start` in Expo Go still works without it.
//
// NOTE: the FCM V1 *service account key* is NOT referenced here — it is uploaded
